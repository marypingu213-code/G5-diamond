...
const review1Data = [
  {
    question: "「就這樣／偶爾偷偷的／溫熱的／親吻過我的臉」上述的哪個部分使用了「疊字」修辭？",
    options: ["就這樣", "偷偷", "溫熱的", "親吻"],
    correctAnswerIndex: 1 
  },
  {
    question: "根據魔術師爸爸的課文內容，在什麼季節時，爸爸會變成葉子，飄落在主角頭髮上，提醒她要多加一件衣服？",
    options: ["春天", "夏天", "秋天", "冬天"],
    correctAnswerIndex: 2
  },
  {
    question: "「我的心裡不禁疑惑：為什麼小丑會出現在醫院裡？」這句話運用了哪種修辭？",
    options: ["感嘆", "設問", "排比", "誇飾"],
    correctAnswerIndex: 1
  },
  {
    question: "「為了使治療順利，醫師會先詢問病人的壯況，以便對症下藥。」句中的哪一個字是錯字？",
    options: ["療", "詢", "壯", "症"],
    correctAnswerIndex: 2
  },
  {
    question: "「滔滔不絕」是什麼意思？",
    options: ["形容說話連續而不間斷", "形容場面冷清而不熱絡", "形容心緒起伏而不安寧", "形容海面平靜而無風浪"],
    correctAnswerIndex: 0
  },
  {
    question: "「這片土地非常□□，一眼望去，完全看不到盡頭。」□中最適合填入哪一個語詞？",
    options: ["燥熱", "偏斜", "廣闊", "渺小"],
    correctAnswerIndex: 2
  },
  {
    question: "根據地下護衛軍一文，下列何者敘述有誤？",
    options: ["秦始皇在生前花費大量人力來為自己建造陵墓", "兵馬俑是農民在挖水井時無意間發現的", "目前只發掘出五十個兵馬俑坑", "兵馬俑具有極高的學術價值"],
    correctAnswerIndex: 2
  },
  {
    question: "在地下護衛軍一文中，秦始皇建造這座陵墓的原因為何？",
    options: ["讓自己的遺體永久不壞", "在裡面修練長生不老之樹", "死後依然能坐擁帝國", "表現出自己的藝術天分"],
    correctAnswerIndex: 2
  },
  {
    question: "「古埃及人為了能得到永生，會將遺體表面塗上樹肢，再用布條包裹，並妥善保存於金字塔中。」句中的哪一個字是錯字？",
    options: ["埃", "肢", "裹", "妥"],
    correctAnswerIndex: 1
  },
  {
    question: "「韋編三絕」是什麼意思？",
    options: ["比喻生活非常辛苦", "比喻能力極為高超", "比喻讀書勤奮努力", "比喻事情相當複雜"],
    correctAnswerIndex: 2
  }
];
